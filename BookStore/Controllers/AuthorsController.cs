...
namespace BookStore.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,AuthorId")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,AuthorId")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
